...
def test_log_model(mock_data_from_spark: from_spark, mock_log_input: log_input, mock_basic_model: BasicModel) -> None:
    ...
    assert mock_data_from_spark.called
...
def test_register_model(
    ...
    client = MlflowClient()
    model_name = f"{mock_basic_model.catalog_name}.{mock_basic_model.schema_name}.hotel_reservations_model_basic"
...
def test_load_latest_model_and_predict(
    ...
    - Loads data using the provided basic model.
